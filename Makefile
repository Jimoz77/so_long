...
SRCS = src/main.c src/exit_fonc.c src/map_fonc.c src/draw_tile.c src/move_fonc.c src/sprite_fonc.c src/sprite_fonc2.c src/else.c src/read_map.c src/draw_map.c src/check_map.c src/move_fonc2.c gnl/get_next_line.c gnl/get_next_line_utils.c
